...
cmake.sh:
	$(call download,cmake.sh,https://cmake.org/files/v3.19/cmake-3.19.2-Linux-x86_64.sh)

qtcreator.7z:
	$(call download,qtcreator.7z,https://download.qt.io/online/qtsdkrepository/linux_x64/desktop/tools_qtcreator/qt.tools.qtcreator/4.14.0-0-202012170942qtcreator.7z)

qtcreator_sdktool.7z:
	$(call download,qtcreator_sdktool.7z,https://download.qt.io/online/qtsdkrepository/linux_x64/desktop/tools_qtcreator/qt.tools.qtcreator/4.14.0-0-202012170942qtcreator_sdktool.7z)
